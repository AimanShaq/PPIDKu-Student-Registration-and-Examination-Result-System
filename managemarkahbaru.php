<?php
    ...
    $sqlinsert= "INSERT INTO tb_resultstud(markStud) VALUES('$fic')";
...
<div class="container-fluid">
    ...
    <form method="POST" action="managemarkahupdprocess.php">
        ...
        <?php echo "<a href='managemarkahdel.php?id=".$row['markStud']."' class='btn btn-danger'><i class='fa fa-trash-alt'></i> Padam Data</a>&nbsp"; ?>
    </form>
</div>
</div>
</div>
