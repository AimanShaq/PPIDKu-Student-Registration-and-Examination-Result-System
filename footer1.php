    <div class="footer-basic">
        <footer>
            ...
            <ul class="list-inline">
                <li class="list-inline-item"><a href="index.php">Laman Utama</a></li>
                <li class="list-inline-item"><a href="index.php#contactus">Tentang Kami</a></li>
                <li class="list-inline-item"><a href="#">Hubungi Kami</a></li>
            </ul>
            <p class="copyright">UTM Quantum © 2019</p>
        </footer>
    </div>
