...
$sqlstud="SELECT * FROM tb_student WHERE studSchool='$schidassign' AND studYear='$tahun'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h2 style="color:white; font-family:calibri">Data Sekolah:</h2>
          <div class="row">
          ...
          <div class="row">
                  ...
                  <div class="card-body">
                      ...
                      <div class="row" style="margin: 0px">
                        <div class=" col-lg-6" style="padding:10px 10px" align="right">
                          <button class="btn btn-info btn-block bg-gradient-info " type="submit" id="submit" data-toggle="modal" data-target="#tunggu" name="submit" style="width:100px;"><i class="fa fa-folder-plus"></i> Tambah</button>
                        </div>
            ...
            <!-- The Modal -->
            <div class="modal" id="tunggu">
              <div class="modal-dialog">
                <div class="modal-content">

                  <!-- Modal Header -->
                  <div class="modal-header">
                    <h4 class="modal-title">Sedang Diproses..</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                  </div>

                  <!-- Modal body -->
                  <div class="modal-body">
                    Data sedang dimasukkan, sila tunggu sebentar..
                  </div>
